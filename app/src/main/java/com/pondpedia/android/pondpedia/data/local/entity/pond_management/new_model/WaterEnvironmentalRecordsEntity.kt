...
import com.pondpedia.android.pondpedia.domain.model.pond_management.new_model.WaterEnvironmentalRecords

@Entity(tableName = "water_environmental_records")
data class WaterEnvironmentalRecordsEntity(
    ...
    fun toWaterEnvironmentRecords(): WaterEnvironmentalRecords {
        return WaterEnvironmentalRecords(
            recordId = recordId,
            date = date,
            pH = pH,
