...
import com.pondpedia.android.pondpedia.domain.model.pond_management.new_model.WaterChemicalRecords

@Entity(tableName = "water_chemical_records")
data class WaterChemicalRecordsEntity(
    ...
    fun toWaterChemicalRecords(): WaterChemicalRecords {
        return WaterChemicalRecords(
            recordId = recordId,
            date = date,
            ammonia = ammonia,
            nitrite = nitrite,
