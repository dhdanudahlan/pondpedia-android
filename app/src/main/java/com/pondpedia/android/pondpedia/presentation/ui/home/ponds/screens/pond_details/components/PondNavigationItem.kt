...
sealed class PondNavigationItem (
    ...
    data object AddRecords: PondNavigationItem(
        route = "POND_ADD_RECORDS",
        labelTextId = R.string.pond_details_add_records,
        titleTextId = R.string.pond_details_add_records,
