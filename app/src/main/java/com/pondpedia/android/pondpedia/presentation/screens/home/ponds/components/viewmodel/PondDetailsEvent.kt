package com.pondpedia.android.pondpedia.presentation.screens.home.ponds.components.viewmodel
...
sealed interface PondDetailsEvent{
    ...
    data class SetCommodityGrowthRecordsDate(val commodityGrowthRecordsDate: String): PondDetailsEvent
    data class SetCommodityGrowthRecordsAge(val commodityGrowthRecordsAge: String): PondDetailsEvent
    data class SetCommodityGrowthRecordsLength(val commodityGrowthRecordsLength: String): PondDetailsEvent
    data class SetCommodityGrowthRecordsWeight(val commodityGrowthRecordsWeight: String): PondDetailsEvent
    data class SetCommodityGrowthRecordsNote(val commodityGrowthRecordsNote: String): PondDetailsEvent

    data class SetCommodityHealthRecordsDate(val commodityHealthRecordsDate: String): PondDetailsEvent
    data class SetCommodityHealthRecordsDeath(val commodityHealthRecordsDeath: String): PondDetailsEvent
    data class SetCommodityHealthRecordsIndicator(val commodityHealthRecordsIndicator: String): PondDetailsEvent
    data class SetCommodityHealthRecordsAction(val commodityHealthRecordsAction: String): PondDetailsEvent
    data class SetCommodityHealthRecordsNote(val commodityHealthRecordsNote: String): PondDetailsEvent
    ...
    data class SetPondCategoryCrossRefCategoryName(val pondCategoryCrossRefCategoryName: String): PondDetailsEvent
