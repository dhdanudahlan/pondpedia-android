...
fun AddCommodityScreen(
    ...
    Column(
        ...
        Row(
            ...
            Button(
                enabled = validateForm(date, name, quantity),
                onClick = {
...
private fun validateForm(date: String, name: String, quantity: String): Boolean {
    return !(date.isBlank() || name.isBlank() || quantity.isBlank())
}
